...
export const DEMO_STUDENT: User = {
  id: 'u-demo-student',
  name: 'Aswathi Nair',
  email: 'aswathi.surveyor@gmail.com',
  phone: '+91 98471 23456',
  role: 'student',
  avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=120&q=80',
  enrolledAt: '2026-08-01',
  district: 'Palakkad',
  targetExam: 'Kerala PSC Surveyor Gr. II & KWA Overseer',
...
export const ENROLLED_STUDENTS_LIST: User[] = [
  DEMO_STUDENT,
  {
    ...
    email: 'anandu.k@gmail.com',
    phone: '+91 94471 88210',
    role: 'student',
    avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&q=80',
    enrolledAt: '2026-08-05',
    district: 'Thiruvananthapuram',
    targetExam: 'Survey & Land Records',
    completedClassIds: ['note-1', 'note-2', 'note-4'],
    bookmarkedClassIds: [],
    savedPYQIds: ['pyq-1'],
    streakDays: 8
  },
  {
    id: 'u-std-2',
    name: 'Sneha Mohan',
    email: 'snehamohan.ce@gmail.com',
    phone: '+91 98460 33412',
    role: 'student',
    avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=120&q=80',
    enrolledAt: '2026-08-08',
    district: 'Kozhikode',
    targetExam: 'KWA Overseer Grade III',
    completedClassIds: ['note-1', 'note-2', 'note-3', 'note-5', 'note-6'],
    bookmarkedClassIds: ['note-8'],
    savedPYQIds: ['pyq-2'],
    streakDays: 21
  },
  {
    id: 'u-std-3',
    name: 'Rahul Varma',
    email: 'rahul.varma98@gmail.com',
    phone: '+91 97455 12984',
    role: 'student',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=120&q=80',
    enrolledAt: '2026-08-12',
    district: 'Ernakulam',
    targetExam: 'Surveyor Grade II',
    completedClassIds: ['note-1', 'note-6'],
    bookmarkedClassIds: [],
    savedPYQIds: ['pyq-1'],
    streakDays: 5
  },
  {
    id: 'u-std-4',
    name: 'Deepa S. Kumar',
    email: 'deepa.skumar@gmail.com',
    phone: '+91 94950 44321',
    role: 'student',
    avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=120&q=80',
    enrolledAt: '2026-08-15',
    district: 'Kollam',
    targetExam: 'Surveyor Gr. II & Tracer',
    completedClassIds: ['note-1', 'note-2', 'note-3', 'note-6', 'note-7'],
    bookmarkedClassIds: ['note-4'],
    savedPYQIds: ['pyq-3'],
    streakDays: 16
  }
];
...
export const INITIAL_STATEWIDE_ATTEMPTS: MockTestAttempt[] = [
  {
    ...
    submittedAt: '2026-08-25T10:21:15Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0, 'msq-9': 0, 'msq-10': 0 },
    markedForReview: [],
    score: 9.34,
    correctCount: 10,
    wrongCount: 2,
  ...
  },
  {
    ...
    submittedAt: '2026-08-25T11:24:40Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0, 'msq-9': 0 },
    markedForReview: ['msq-10'],
    score: 9.00,
    correctCount: 9,
    wrongCount: 0,
    unattemptedCount: 1,
  ...
  },
  {
    ...
    submittedAt: '2026-08-25T14:52:10Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0, 'msq-9': 0, 'msq-10': 1 },
    markedForReview: [],
    score: 8.67,
    correctCount: 9,
    wrongCount: 1,
  ...
  },
  {
    ...
    testId: 'mock-state-rank-1',
    userId: 'u-std-rank-4',
    userName: 'Deepa S. Nair',
    userAvatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=120&q=80',
    district: 'Thrissur',
    startedAt: '2026-08-25T15:00:00Z',
    submittedAt: '2026-08-25T15:25:05Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0, 'msq-9': 1, 'msq-10': 2 },
    markedForReview: [],
    score: 8.34,
    correctCount: 9,
    wrongCount: 2,
  ...
  },
  {
    ...
    testId: 'mock-state-rank-1',
    userId: 'u-std-rank-5',
    userName: 'Mohammed Ashiq',
    userAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=120&q=80',
    district: 'Malappuram',
    startedAt: '2026-08-25T16:00:00Z',
    submittedAt: '2026-08-25T16:26:30Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0 },
    markedForReview: [],
    score: 8.00,
    correctCount: 8,
    wrongCount: 0,
  ...
  },
  {
    ...
    testId: 'mock-state-rank-1',
    userId: 'u-std-rank-6',
    userName: 'Kavya Ramesh',
    userAvatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=120&q=80',
    district: 'Idukki',
    startedAt: '2026-08-25T17:10:00Z',
    submittedAt: '2026-08-25T17:38:15Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0, 'msq-9': 2 },
    markedForReview: [],
    score: 7.67,
    correctCount: 8,
    wrongCount: 1,
  ...
  },
  {
    ...
    submittedAt: '2026-08-25T18:27:45Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 0, 'msq-9': 1, 'msq-10': 3 },
    markedForReview: [],
    score: 7.34,
    correctCount: 8,
    wrongCount: 2,
  ...
  },
  {
    ...
    testId: 'mock-state-rank-1',
    userId: 'u-std-rank-8',
    userName: 'Reshmi V. Pillai',
    userAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=120&q=80',
    district: 'Kollam',
    startedAt: '2026-08-25T19:00:00Z',
    submittedAt: '2026-08-25T19:30:10Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0 },
    markedForReview: [],
    score: 7.00,
    correctCount: 7,
    wrongCount: 0,
  ...
  },
  {
    ...
    district: 'Palakkad',
    startedAt: '2026-08-25T19:40:00Z',
    submittedAt: '2026-08-25T20:09:20Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 2 },
    markedForReview: [],
    score: 6.67,
    correctCount: 7,
    wrongCount: 1,
  ...
  },
  {
    id: 'att-rank-10',
    testId: 'mock-state-rank-1',
    userId: 'u-std-rank-10',
    userName: 'Aswathy Mohan',
    userAvatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=120&q=80',
    district: 'Alappuzha',
    startedAt: '2026-08-25T20:15:00Z',
    submittedAt: '2026-08-25T20:46:00Z',
    answers: { 'msq-1': 0, 'msq-2': 0, 'msq-3': 1, 'msq-4': 0, 'msq-5': 0, 'msq-6': 0, 'msq-7': 0, 'msq-8': 1, 'msq-9': 3 },
    markedForReview: [],
    score: 6.34,
    correctCount: 7,
    wrongCount: 2,
  ...
  // -------------------------------------------------------------
  // STATEWIDE RANKINGS FOR 87 MCQ MASTER TEST SERIES (mock-kpsc-master-87)
  // -------------------------------------------------------------
  {
    id: 'att-m87-1',
    ...
    submittedAt: '2026-08-26T10:57:00Z',
    answers: {},
    markedForReview: [],
    score: 81.34,
    correctCount: 82,
  ...
  },
  {
    ...
    submittedAt: '2026-08-26T11:58:30Z',
    answers: {},
    markedForReview: [],
    score: 78.01,
    correctCount: 79,
  ...
  },
  {
    ...
    userAvatar: 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?auto=format&fit=crop&w=120&q=80',
    district: 'Thiruvananthapuram',
    startedAt: '2026-08-26T14:30:00Z',
  ...
  },
  {
    ...
    submittedAt: '2026-08-26T16:02:30Z',
    answers: {},
    markedForReview: [],
    score: 71.35,
    correctCount: 73,
  ...
  },
  {
    ...
    submittedAt: '2026-08-26T17:03:40Z',
    answers: {},
    markedForReview: [],
    score: 68.68,
    correctCount: 71,
  ...
  },
  {
    ...
    userAvatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=120&q=80',
    district: 'Idukki',
    startedAt: '2026-08-26T17:10:00Z',
    submittedAt: '2026-08-26T18:15:00Z',
    answers: {},
    markedForReview: [],
    score: 66.01,
    correctCount: 69,
  ...
  },
  {
    ...
    submittedAt: '2026-08-26T19:07:30Z',
    answers: {},
    markedForReview: [],
    score: 63.34,
    correctCount: 67,
  ...
  },
  {
    ...
    submittedAt: '2026-08-26T20:08:40Z',
    answers: {},
    markedForReview: [],
    score: 60.67,
    correctCount: 65,
  ...
  },
  {
    ...
    userAvatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=120&q=80',
    district: 'Palakkad',
    startedAt: '2026-08-26T19:40:00Z',
    submittedAt: '2026-08-26T20:50:00Z',
    answers: {},
    markedForReview: [],
    score: 57.00,
    correctCount: 63,
  ...
  },
  {
    ...
    userAvatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=120&q=80',
    district: 'Alappuzha',
    startedAt: '2026-08-26T20:15:00Z',
    submittedAt: '2026-08-26T21:27:30Z',
    answers: {},
    markedForReview: [],
    score: 54.33,
    correctCount: 61,
