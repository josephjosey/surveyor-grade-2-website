...
export const THEODOLITE_30_QUESTIONS: BankQuestion[] = [
  {
    "id": "q-theo-1",
    "moduleId": "mod-6",
    "moduleNumber": 6,
    ...
    "type": "pyq",
    "examName": "Kerala PSC Surveyor Gr. II / Theodolite Bank",
    "year": 2024,
...
export const MOCK_TEST_THEODOLITE_30: MockTest = {
  ...
  title: 'Theodolite 30 MCQ High-Yield Master Practice Exam',
  category: 'Module Specific',
  description: 'Official Kerala PSC Mock Test covering 30 high-yield questions on Theodolite Surveying, components (upper/inner spindle, lower/outer spindle), transiting, swinging, vertical index errors, plate bubbles, collimation test, cross-hair ring test, optical plummet, and repetition & reiteration methods. Evaluated with standard PSC negative marking (+1.00 / -0.33).',
  durationMinutes: 30,
  totalQuestions: 30,
  marksPerCorrect: 1,
